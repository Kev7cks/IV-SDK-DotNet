...
namespace IVSDKDotNet
{
	...
	uint32_t MemoryAccess::GetAbsoluteAddress(uint32_t addr1070, uint32_t addr1080, uint32_t addr12059)
	{
		return AddressSetter::Get(addr1070, addr1080, addr12059);
	}
	...
	uint32_t MemoryAccess::GetValue(uint32_t addr1070, uint32_t addr1080, uint32_t addr12059)
	{
		switch (m_eGameVersion)
		{
			...
			case eGameVersion::VERSION_12059: return m_baseAddress + addr12059;
		}

		return 0;
	}
	void MemoryAccess::SetValue(uint32_t newValue, uint32_t addr1070, uint32_t addr1080, uint32_t addr12059)
	{
		switch (m_eGameVersion)
		{
			...
			case eGameVersion::VERSION_12059: *(uint32_t*)(m_baseAddress + addr12059) = newValue; break;
		}
	}
